...
public abstract class CommonMethods {
    ...
    public String showError (int ErrorIndex){
        ...
        ErrorList.add("Error 2: No posee los permisos necesarios para crear un subforo.");
        ErrorList.add("Error 3: No es posible acceder al menú de admisitrador porque la cuenta no posee los permisos necesarios.");
        ErrorList.add("Error 4: No es posible acceder al menú de creador porque la cuenta no posee los permisos necesarios.");
